        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="!p-2"><form method="POST"
                        ...
                        }}}><input type="hidden" value={row.email} name="email"/><button class="btn variant-filled-error rounded w-full">Unban</button></td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-center" >{data.bans.length}</td>
                </tr>
            </tfoot>
        </table>
    </div>
